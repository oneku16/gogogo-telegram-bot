...
MESSAGES: Dict[str, Dict[str, str]] = {
    LANG_EN: {
        ...
        "btn_change_name": "Change Name ✏️",
        "active_post_limit": "⚠️ You already have an active post:\n{post_summary}\n\nDo you want to stop it and create a new one?",
        "overwrite_yes": "Yes, Stop & Create 🆕",
        "overwrite_no": "No, Keep Active 🛑",
        "loc_other": "Other... 🏳️",
        "other_city_prompt": "Please type the name of the city:",
    ...
    LANG_RU: {
        ...
        "btn_edit_post": "Изменить Пост 📝",
        "profile_title": "<b>Профиль 👤</b>\nИмя: {name}\nТелефон: {phone}\nРоль: {role}",
        "btn_change_phone": "Сменить Телефон 📱",
        "btn_change_name": "Сменить Имя ✏️",
        "active_post_limit": "⚠️ У вас уже есть активный пост:\n{post_summary}\n\nХотите остановить его и создать новый?",
        "overwrite_yes": "Да, Создать Новый 🆕",
        "overwrite_no": "Нет, Оставить 🛑",
        "loc_other": "Другое... 🏳️",
        "other_city_prompt": "Пожалуйста, введите название города:",
    ...
    LANG_KG: {
        ...
        "settings_button": "Баптоолор ⚙️",
        "btn_change_lang": "Тилди өзгөртүү 🌐",
        "btn_change_role": "Ролду алмаштыруу 🔄",
        "btn_change_role": "Ролду алмаштыруу 🔄",
        "btn_profile": "Профиль 👤",
        "btn_cancel_search": "Издөөнү токтотуу 🛑",
        "btn_edit_post": "Өзгөртүү 📝",
        "profile_title": "<b>Профиль 👤</b>\nАты: {name}\nТел: {phone}\nРоль: {role}",
        "btn_change_phone": "Тел алмаштыруу 📱",
        "btn_change_name": "Аты алмаштыруу ✏️",
        "active_post_limit": "⚠️ Сизде активдүү пост бар:\n{post_summary}\n\nАны токтотуп, жаңысын түзөсүзб?",
        "overwrite_yes": "Ооба, Жаңылоо 🆕",
        "overwrite_no": "Жок, Калтыруу 🛑",
        "loc_other": "Башка... 🏳️",
        "other_city_prompt": "Шаардын атын жазыңыз:",
